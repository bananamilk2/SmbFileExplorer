...
public class FileDao extends AbstractDao<File, Long> {
    ...
    public static class Properties {
        ...
        public final static Property FileHash = new Property(1, String.class, "fileHash", false, "FILE_HASH");
        public final static Property FileSource = new Property(2, String.class, "fileSource", false, "FILE_SOURCE");
        ...
        public final static Property FileTime = new Property(5, java.util.Date.class, "fileTime", false, "FILE_TIME");
        public final static Property DownloadTime = new Property(6, java.util.Date.class, "downloadTime", false, "DOWNLOAD_TIME");
        public final static Property Dir = new Property(7, boolean.class, "dir", false, "DIR");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"tableFiles\" (" + //
                ...
                "\"FILE_HASH\" TEXT," + // 1: fileHash
                "\"FILE_SOURCE\" TEXT," + // 2: fileSource
                "\"FILE_NAME\" TEXT," + // 3: fileName
                "\"FILE_SIZE\" INTEGER," + // 4: fileSize
                "\"FILE_TIME\" INTEGER," + // 5: fileTime
                "\"DOWNLOAD_TIME\" INTEGER," + // 6: downloadTime
                "\"DIR\" INTEGER NOT NULL ," + // 7: dir
    ...
    protected final void bindValues(DatabaseStatement stmt, File entity) {
        ...
        if (fileHash != null) {
            stmt.bindString(2, fileHash);
        }
 
        String fileSource = entity.getFileSource();
        if (fileSource != null) {
            stmt.bindString(3, fileSource);
        }
        ...
        if (fileTime != null) {
            stmt.bindLong(6, fileTime.getTime());
        }
 
        java.util.Date downloadTime = entity.getDownloadTime();
        if (downloadTime != null) {
            stmt.bindLong(7, downloadTime.getTime());
        }
        stmt.bindLong(8, entity.getDir() ? 1L: 0L);
    ...
    public File readEntity(Cursor cursor, int offset) {
        File entity = new File( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // fileHash
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // fileSource
            ...
            cursor.isNull(offset + 5) ? null : new java.util.Date(cursor.getLong(offset + 5)), // fileTime
            cursor.isNull(offset + 6) ? null : new java.util.Date(cursor.getLong(offset + 6)), // downloadTime
            cursor.getShort(offset + 7) != 0, // dir
    ...
    public void readEntity(Cursor cursor, File entity, int offset) {
        ...
        entity.setFileHash(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setFileSource(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        ...
        entity.setFileTime(cursor.isNull(offset + 5) ? null : new java.util.Date(cursor.getLong(offset + 5)));
        entity.setDownloadTime(cursor.isNull(offset + 6) ? null : new java.util.Date(cursor.getLong(offset + 6)));
        entity.setDir(cursor.getShort(offset + 7) != 0);
